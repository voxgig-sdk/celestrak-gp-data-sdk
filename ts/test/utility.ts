...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.CELESTRAKGPDATA_TEST_LIVE ||
    'TRUE' === process.env.CELESTRAKGPDATA_TEST_OVERRIDE
  ) {
  ...
  m.CELESTRAKGPDATA_TEST_EXPLAIN = process.env.CELESTRAKGPDATA_TEST_EXPLAIN || m.CELESTRAKGPDATA_TEST_EXPLAIN
