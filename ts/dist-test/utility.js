...
function envOverride(m) {
    if ('TRUE' === process.env.CELESTRAK_GP_DATA_TEST_LIVE ||
        'TRUE' === process.env.CELESTRAK_GP_DATA_TEST_OVERRIDE) {
    ...
    m.CELESTRAK_GP_DATA_TEST_EXPLAIN = process.env.CELESTRAK_GP_DATA_TEST_EXPLAIN || m.CELESTRAK_GP_DATA_TEST_EXPLAIN;
    return m;
}
