...
(0, node_test_1.describe)('GpnDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CelestrakGpDataSDK({
    ...
    (0, node_test_1.test)('direct-list-gpn', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-gpn', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.CELESTRAK_GP_DATA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CelestrakGpDataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CELESTRAK_GP_DATA_TEST_GPN_ENTID'];
    ...
    const client = new __1.CelestrakGpDataSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GpnDirect.test.js.map