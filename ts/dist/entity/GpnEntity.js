...
class GpnEntity extends CelestrakGpDataEntityBase_1.CelestrakGpDataEntityBase {
    ...
    make() {
        return new GpnEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Gpn[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.GpnEntity = GpnEntity;
//# sourceMappingURL=GpnEntity.js.map