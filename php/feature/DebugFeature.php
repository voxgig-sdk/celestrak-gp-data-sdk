...
// CelestrakGpData SDK debug feature
...
class CelestrakGpDataDebugFeature extends CelestrakGpDataBaseFeature
{
    ...
    private function _finish(CelestrakGpDataContext $ctx, bool $ok): void
    {
