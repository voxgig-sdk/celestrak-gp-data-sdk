...
// CelestrakGpData SDK streaming feature
...
class CelestrakGpDataStreamingFeature extends CelestrakGpDataBaseFeature
{
    ...
    private function _iterate(CelestrakGpDataResult $result): \Generator
    {
    ...
    private function _streamable(CelestrakGpDataContext $ctx): bool
    {
