...
// CelestrakGpData SDK timeout feature
...
class CelestrakGpDataTimeoutFeature extends CelestrakGpDataBaseFeature
{
    ...
    private function _with_timeout(CelestrakGpDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CelestrakGpDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
