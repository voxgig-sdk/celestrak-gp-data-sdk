...
// CelestrakGpData SDK rbac feature
...
class CelestrakGpDataRbacFeature extends CelestrakGpDataBaseFeature
{
    ...
    private function _required(CelestrakGpDataContext $ctx): ?string
    {
    ...
    private function _reject(CelestrakGpDataContext $ctx, string $required): void
    {
    ...
    private function _track(CelestrakGpDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
