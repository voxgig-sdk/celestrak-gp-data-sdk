...
// CelestrakGpData SDK utility: result_basic

class CelestrakGpDataResultBasic
{
    public static function call(CelestrakGpDataContext $ctx): ?CelestrakGpDataResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof CelestrakGpDataError) ? $result->err->msg : (string)$result->err;
