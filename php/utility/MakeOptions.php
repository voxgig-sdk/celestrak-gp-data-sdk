...
// CelestrakGpData SDK utility: make_options

class CelestrakGpDataMakeOptions
{
    ...
    public static function call(CelestrakGpDataContext $ctx): array
    {
        ...
        //
        // `CelestrakGpDataSchema::optspec()` is built from the model:
        ...
        $optspec = CelestrakGpDataSchema::optspec();
