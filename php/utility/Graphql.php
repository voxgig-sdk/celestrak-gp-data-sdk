...
// CelestrakGpData SDK utility: graphql
//
...
class CelestrakGpDataGraphql
{
    ...
    // equivalent.
    public static function body(CelestrakGpDataContext $ctx): mixed
    {
    ...
    public static function errors(CelestrakGpDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
