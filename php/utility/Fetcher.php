...
// CelestrakGpData SDK utility: fetcher

class CelestrakGpDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CelestrakGpDataSDK/1.0)';
    ...
    public static function call(CelestrakGpDataContext $ctx, string $fullurl, array $fetchdef): array
    {
