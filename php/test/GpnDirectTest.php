...
class GpnDirectTest extends TestCase
{
    public function test_direct_list_gpn(): void
    {
        $setup = gpn_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-gpn", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
