...
// CelestrakGpData SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CelestrakGpDataOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CelestrakGpDataOmni::structfix($now, Struct::undef()))
                        !== json_encode(CelestrakGpDataOmni::structfix($val, Struct::undef()))) {
