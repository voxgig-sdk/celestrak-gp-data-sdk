...
// CelestrakGpData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CelestrakGpDataSDK::test)
...
{
    private const SDK_CLASS = 'CelestrakGpDataSDK';
    ...
    private const SDK_BASE = 'celestrakgpdata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../celestrakgpdata_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
