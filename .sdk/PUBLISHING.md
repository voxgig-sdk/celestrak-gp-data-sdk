...
|---|---|---|
| `ts/` | @voxgig-sdk/celestrak-gp-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/celestrak-gp-data-sdk \
      --repository voxgig-sdk/celestrak-gp-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/celestrak-gp-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/celestrak-gp-data-sdk --id=<id>` removes it.
