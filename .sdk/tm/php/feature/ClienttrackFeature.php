...
// CelestrakGpData SDK clienttrack feature
...
class CelestrakGpDataClienttrackFeature extends CelestrakGpDataBaseFeature
{
    ...
    public function PostConstruct(CelestrakGpDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CelestrakGpData-SDK';
