...
// CelestrakGpData SDK cache feature
...
class CelestrakGpDataCacheFeature extends CelestrakGpDataBaseFeature
{
    ...
    private function _through(CelestrakGpDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
