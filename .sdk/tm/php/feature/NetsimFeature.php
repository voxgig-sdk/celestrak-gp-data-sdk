...
// CelestrakGpData SDK netsim feature
...
class CelestrakGpDataNetsimFeature extends CelestrakGpDataBaseFeature
{
    ...
    private function _simulate(CelestrakGpDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CelestrakGpDataContext $ctx, array $applied): void
    {
        $client = $this->client;
