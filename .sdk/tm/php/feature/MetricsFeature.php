...
// CelestrakGpData SDK metrics feature
...
class CelestrakGpDataMetricsFeature extends CelestrakGpDataBaseFeature
{
    ...
    private function _record(CelestrakGpDataContext $ctx, bool $ok): void
    {
