...
// CelestrakGpData SDK ratelimit feature
...
class CelestrakGpDataRatelimitFeature extends CelestrakGpDataBaseFeature
{
    ...
    private function _acquire(CelestrakGpDataContext $ctx): void
    {
    ...
    private function _track(CelestrakGpDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
