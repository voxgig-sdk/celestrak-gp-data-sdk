...
// CelestrakGpData SDK audit feature
...
class CelestrakGpDataAuditFeature extends CelestrakGpDataBaseFeature
{
    ...
    private function _emit(CelestrakGpDataContext $ctx, string $outcome): void
    {
