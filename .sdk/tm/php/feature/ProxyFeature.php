...
// CelestrakGpData SDK proxy feature
...
class CelestrakGpDataProxyFeature extends CelestrakGpDataBaseFeature
{
    ...
    public function init(CelestrakGpDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CelestrakGpDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
