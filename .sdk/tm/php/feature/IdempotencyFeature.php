...
// CelestrakGpData SDK idempotency feature
...
class CelestrakGpDataIdempotencyFeature extends CelestrakGpDataBaseFeature
{
    ...
    private function _mutating(CelestrakGpDataContext $ctx): bool
    {
