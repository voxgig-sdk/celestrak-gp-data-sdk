...
// CelestrakGpData SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CelestrakGpDataTransformResponse
{
    public static function call(CelestrakGpDataContext $ctx): mixed
    {
        ...
        $transform = CelestrakGpDataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
