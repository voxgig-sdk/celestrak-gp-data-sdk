...
// CelestrakGpData SDK utility type

class CelestrakGpDataUtility
{
    ...
    public static function copy(CelestrakGpDataUtility $src): CelestrakGpDataUtility
    {
        $u = new CelestrakGpDataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
