# CelestrakGpData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CelestrakGpDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CelestrakGpDataSDK(...) and CelestrakGpDataSDK.test(...) become
#      CelestrakGpDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "celestrakgpdata_sdk"
_SDK_CLASS = "CelestrakGpDataSDK"
