...
from celestrakgpdata_sdk.utility import register

# Load features
from celestrakgpdata_sdk.feature.base_feature import CelestrakGpDataBaseFeature
from celestrakgpdata_sdk.features import _has_feature, _make_feature
...
class CelestrakGpDataSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = CelestrakGpDataUtility()
    ...
    def get_utility(self):
        return CelestrakGpDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CelestrakGpDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Gpn(self, data=None) -> "GpnEntity":
        ...
        from celestrakgpdata_sdk.entity.gpn_entity import GpnEntity
