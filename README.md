...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/celestrak-gp-data` | `npm install @voxgig-sdk/celestrak-gp-data` |
| Python | `voxgig-sdk-celestrak-gp-data` | `pip install voxgig-sdk-celestrak-gp-data` |
| PHP | `voxgig-sdk/celestrak-gp-data` | `composer require voxgig-sdk/celestrak-gp-data` |
| Golang | `github.com/voxgig-sdk/celestrak-gp-data-sdk/go` | `go get github.com/voxgig-sdk/celestrak-gp-data-sdk/go` |
| Ruby | `voxgig-sdk-celestrak-gp-data` | `gem install voxgig-sdk-celestrak-gp-data` |
| Lua | `voxgig-sdk-celestrak-gp-data` | `luarocks install voxgig-sdk-celestrak-gp-data` |
