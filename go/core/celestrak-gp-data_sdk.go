...
type CelestrakGpDataSDK struct {
	Mode     string
...
func (sdk *CelestrakGpDataSDK) OptionsMap() map[string]any {
...
func (sdk *CelestrakGpDataSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CelestrakGpDataSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CelestrakGpDataSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CelestrakGpDataSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CelestrakGpDataSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CelestrakGpDataSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CelestrakGpDataSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CelestrakGpDataSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CelestrakGpDataSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CelestrakGpDataSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *CelestrakGpDataSDK {
	...
	sdk := NewCelestrakGpDataSDK(sdkopts)
	sdk.Mode = "test"
