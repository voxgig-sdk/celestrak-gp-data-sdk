...
type GpnEntity struct {
	name    string
	client  *core.CelestrakGpDataSDK
...
func NewGpnEntity(client *core.CelestrakGpDataSDK, entopts map[string]any) *GpnEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GpnEntity) GetName() string { return e.name }
...
func (e *GpnEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GpnEntity) Deleted() bool {
	return e.deleted
}


func (e *GpnEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGpnEntity(e.client, opts)
}

func (e *GpnEntity) Data(args ...any) any {
...
func (e *GpnEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GpnEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GpnEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *GpnEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GpnEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GpnEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GpnEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
