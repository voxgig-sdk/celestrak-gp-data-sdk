...
#      offline in seeded test mode (CelestrakGpDataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CelestrakGpData_sdk.rb")
  SDK_CLASS = "CelestrakGpDataSDK"
