// Command CelestrakGpData-mcp is an MCP server exposing the CelestrakGpData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CelestrakGpData_list  — list records of an entity
//	CelestrakGpData_load  — load a single record of an entity
//
