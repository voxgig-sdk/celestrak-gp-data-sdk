...
type Args struct {
	Entity string         `json:"entity" jsonschema:"gpn"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CelestrakGpDataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "celestrak-gp-data_list",
		Description: "List records from CelestrakGpData. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "celestrak-gp-data_load",
		Description: "Load a single record from CelestrakGpData. " +
...
func runOp(client *sdk.CelestrakGpDataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CelestrakGpDataSDK, name string) (sdk.CelestrakGpDataEntity, error) {
	switch strings.ToLower(name) {
	case "gpn":
		return client.Gpn(nil), nil
