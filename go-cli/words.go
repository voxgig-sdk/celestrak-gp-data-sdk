...
func registerSDKWords(r *eng.Registry, client *sdk.CelestrakGpDataSDK) {
...
func runOp(client *sdk.CelestrakGpDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
