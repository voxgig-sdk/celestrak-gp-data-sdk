...
describe("GpnDirect", function()
  it("should direct-list-gpn", function()
    local setup = gpn_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-gpn", setup.live and "live" or "unit")
...
function gpn_direct_setup(mockres)
