...
function runner.env_override(m)
  local live = runner.getenv("CELESTRAKGPDATA_TEST_LIVE")
  local override = runner.getenv("CELESTRAKGPDATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CELESTRAKGPDATA_TEST_EXPLAIN")
