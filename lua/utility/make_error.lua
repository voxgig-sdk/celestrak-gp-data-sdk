...
local function make_error_util(ctx, err)
  ...
  local msg = "CelestrakGpDataSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = CelestrakGpDataError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == CelestrakGpDataError then
